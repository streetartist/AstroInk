...
static const uint32_t __attribute((aligned(64))) js_stdlib_table[] = {
  ...
  0x6e697270,
  0x00000074,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (2 << (JS_MTAG_BITS + 3)), /* "ai" (offset=767) */
  0x00006961,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (6 << (JS_MTAG_BITS + 3)), /* "millis" (offset=769) */
  0x6c6c696d,
  0x00007369,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (5 << (JS_MTAG_BITS + 3)), /* "sleep" (offset=772) */
  0x65656c73,
  0x00000070,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (5 << (JS_MTAG_BITS + 3)), /* "kvGet" (offset=775) */
  0x6547766b,
  0x00000074,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (5 << (JS_MTAG_BITS + 3)), /* "kvSet" (offset=778) */
  0x6553766b,
  0x00000074,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (8 << (JS_MTAG_BITS + 3)), /* "readFile" (offset=781) */
  0x64616572,
  0x656c6946,
  0x00000000,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (9 << (JS_MTAG_BITS + 3)), /* "writeFile" (offset=785) */
  0x74697277,
  0x6c694665,
  0x00000065,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (6 << (JS_MTAG_BITS + 3)), /* "exists" (offset=789) */
  0x73697865,
  0x00007374,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (7 << (JS_MTAG_BITS + 3)), /* "screenW" (offset=792) */
  0x65726373,
  0x00576e65,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (7 << (JS_MTAG_BITS + 3)), /* "screenH" (offset=795) */
  0x65726373,
  0x00486e65,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (7 << (JS_MTAG_BITS + 3)), /* "appExit" (offset=798) */
  0x45707061,
  0x00746978,

  /* sorted atom table (offset=801) */
  JS_VALUE_ARRAY_HEADER(239),
  ...
  JS_ROM_VALUE(775), /* kvGet */
  JS_ROM_VALUE(778), /* kvSet */
  ...
  JS_ROM_VALUE(795), /* screenH */
  JS_ROM_VALUE(792), /* screenW */
  ...
  JS_ROM_VALUE(785), /* writeFile */
  JS_ROM_VALUE(131), /* yield */

  /* properties (offset=1041) */
  ...
  /* global object properties (offset=2282) */
  JS_VALUE_ARRAY_HEADER(82),
  JS_ROM_VALUE(224) /* Object */,
  JS_ROM_VALUE(1080),
  JS_ROM_VALUE(253) /* Function */,
  JS_ROM_VALUE(1132),
...
static const JSCFunctionDef js_c_function_table[] = {
  ...
  { { .generic = js_ai_log },
    JS_ROM_VALUE(542) /* log */,
    JS_CFUNC_generic, 1, 0 },
  { { .generic = js_ai_millis },
    JS_ROM_VALUE(769) /* millis */,
    JS_CFUNC_generic, 0, 0 },
  { { .generic = js_ai_sleep },
    JS_ROM_VALUE(772) /* sleep */,
    JS_CFUNC_generic, 1, 0 },
  { { .generic = js_ai_kv_get },
    JS_ROM_VALUE(775) /* kvGet */,
    JS_CFUNC_generic, 1, 0 },
  { { .generic = js_ai_kv_set },
    JS_ROM_VALUE(778) /* kvSet */,
    JS_CFUNC_generic, 2, 0 },
  { { .generic = js_ai_read_file },
    JS_ROM_VALUE(781) /* readFile */,
    JS_CFUNC_generic, 1, 0 },
  { { .generic = js_ai_write_file },
    JS_ROM_VALUE(785) /* writeFile */,
    JS_CFUNC_generic, 2, 0 },
  { { .generic = js_ai_exists },
    JS_ROM_VALUE(789) /* exists */,
    JS_CFUNC_generic, 1, 0 },
  { { .generic = js_ai_screen_w },
    JS_ROM_VALUE(792) /* screenW */,
    JS_CFUNC_generic, 0, 0 },
  { { .generic = js_ai_screen_h },
    JS_ROM_VALUE(795) /* screenH */,
    JS_CFUNC_generic, 0, 0 },
  { { .generic = js_ai_app_exit },
    JS_ROM_VALUE(798) /* appExit */,
    JS_CFUNC_generic, 1, 0 },
